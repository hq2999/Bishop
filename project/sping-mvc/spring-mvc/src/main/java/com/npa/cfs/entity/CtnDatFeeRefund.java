...
/**
 * The persistent class for the CTN_DAT_FEE_REFUND database table.
 * 
 */
@Entity
@Table(name="CTN_DAT_FEE_REFUND")
@NamedQuery(name="CtnDatFeeRefund.findAll", query="SELECT c FROM CtnDatFeeRefund c")
public class CtnDatFeeRefund implements Serializable {
