...
/**
 * The persistent class for the CTN_DAT_FEE_RECEIVED database table.
 * 
 */
@Entity
@Table(name="CTN_DAT_FEE_RECEIVED")
@NamedQuery(name="CtnDatFeeReceived.findAll", query="SELECT c FROM CtnDatFeeReceived c")
public class CtnDatFeeReceived implements Serializable {
