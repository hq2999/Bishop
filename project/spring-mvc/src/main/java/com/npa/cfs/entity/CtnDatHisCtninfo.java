...
/**
 * The persistent class for the CTN_DAT_HIS_CTNINFO database table.
 * 
 */
@Entity
@Table(name="CTN_DAT_HIS_CTNINFO")
@NamedQuery(name="CtnDatHisCtninfo.findAll", query="SELECT c FROM CtnDatHisCtninfo c")
public class CtnDatHisCtninfo implements Serializable {
