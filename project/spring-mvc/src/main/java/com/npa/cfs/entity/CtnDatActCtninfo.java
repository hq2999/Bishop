...
/**
 * The persistent class for the CTN_DAT_ACT_CTNINFO database table.
 * 
 */
@Entity
@Table(name="CTN_DAT_ACT_CTNINFO")
@NamedQuery(name="CtnDatActCtninfo.findAll", query="SELECT c FROM CtnDatActCtninfo c")
public class CtnDatActCtninfo implements Serializable {
